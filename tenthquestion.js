...
const loadQuestion = () => {
    ...
    const correctAnswerA=()=>{
        answerA.addEventListener("click", () => {
            ...
            localStorage.setItem("moneyEarn",1000000)
            let soundNosound=localStorage.getItem("sound")
            if (soundNosound=='false') {
            ...
            window.location="eleventhquestion.html"
        })
        ...
        retryBtn.addEventListener("click",()=>{
            ...
            if (getRetry>0) {
                ...
                if (retryNumber==0) {
                    let questionObj={
                        question:"Counting of money with moist hand is",
                        choice1:"Adhesion",
                        choice2:"Diffusion",
                        choice3:"Osmosis", 
                        choice4:"Cohesion"
                ...
                if (retryNumber==1) {
                    let questionObj={
                        question:"The ability to resist change is",
                        choice1:"Inertia",
                        choice2:"Resistance",
                        choice3:"Capacitance", 
                        choice4:"Impedance"
                ...
                if (retryNumber==2) {
                    let questionObj={
                        question:"Which has the lowest PRa value",
                        choice1:"Phenol",
                        choice2:"Propanol",
                        choice3:"Ethanol", 
                        choice4:"Methanol "
                ...
                if (retryNumber==3) {
                    let questionObj={
                        question:"Which of the following is not a mineral of fluorine",
                        choice1:"Carnalite",
                        choice2:"Cryolite",
                        choice3:"Fluorspar", 
                        choice4:"Fluoropalite"
                    }
                    allQuestions.push(questionObj)
                    document.getElementById("questionBox").innerHTML=`${questionObj.question}`
                    document.getElementById("optionA").innerHTML=`${questionObj.choice1}`
                ...
                if (retryNumber==4) {
                    let questionObj={
                        question:"What is the boiling point of helium?",
                        choice1:"4.2k",
                        choice2:"3.7k",
                        choice3:"7.8k", 
                        choice4:"6.3k"
    ...
    const correctAnswerB=()=>{
        ...
        retryBtn.addEventListener("click",()=>{
            ...
            if (getRetry>0) {
                ...
                if (retryNumber==0) {
                    let questionObj={
                        question:"The mechanism that causes damage to cell from radiation exposure is",
                        choice1:"Cancer",
                        choice2:"Ionization",
                        choice3:"Tumor", 
                        choice4:"Excitation"
                ...
                if (retryNumber==2) {
                    let questionObj={
                        question:". Halides react with ___________ to form covalent compounds",
                        choice1:"Non-metals",
                        choice2:"Alkali",
                        choice3:"Acid", 
                        choice4:"Propene"
                ...
                if (retryNumber==3) {
                    let questionObj={
                        question:"Which halide has the most basic nature in water",
                        choice1:"Chloride",
                        choice2:"Fluoride",
                        choice3:"Bromide", 
                        choice4:"Iodide"
                ...
                if (retryNumber==4) {
                    let questionObj={
                        question:"Which has the lowest % of S?",
                        choice1:"Sp3",
                        choice2:"Sp2",
                        choice3:"Sp", 
                        choice4:"Sp4"
                ...
                if (retryNumber==5) {
                    let questionObj={
                        question:"Which of these has an ionic character?",
                        choice1:"Sr",
                        choice2:"Be",
                        choice3:"Mg", 
                        choice4:"Ca"
    ...
    const correctAnswerC=()=>{
        ...
        retryBtn.addEventListener("click",()=>{
            ...
            if (getRetry>0) {
                ...
                if (retryNumber==0) {
                    let questionObj={
                        question:"Which halogen is used in the manufacture of disinfectants",
                        choice1:"Fluorine",
                        choice2:"Bromine",
                        choice3:"Chlorine", 
                        choice4:"Iodine"
                ...
                if (retryNumber==1) {
                    let questionObj={
                        question:"The characteristic colour obtained when Na is burnt in Bunsen flame is",
                        choice1:"Lilac",
                        choice2:"Violet",
                        choice3:"Yellow", 
                        choice4:"Blue"
                ...
                if (retryNumber==2) {
                    let questionObj={
                        question:"Caesium is __________ on a warm day",
                        choice1:"Gas",
                        choice2:"Water",
                        choice3:"Liquid", 
                        choice4:"Solid"
                ...
                if (retryNumber==3) {
                    let questionObj={
                        question:"The number of isomers formed by C5H10 is ",
                        choice1:"4",
                        choice2:"2",
                        choice3:"3", 
                        choice4:"1"
                ...
                if (retryNumber==4) {
                    let questionObj={
                        question:"A molecule of nitrogen contains ________ bond ",
                        choice1:"Tetra",
                        choice2:"Double",
                        choice3:"Triple", 
                        choice4:"Single"
                ...
                if (retryNumber==5) {
                    let questionObj={
                        question:"A tetradentate ligand has ________ donor atom",
                        choice1:"2",
                        choice2:"3",
                        choice3:"4", 
                        choice4:"5"
    ...
    const correctAnswerD=()=>{
        ...
        retryBtn.addEventListener("click",()=>{
            ...
            if (getRetry>0) {
                ...
                if (retryNumber==0) {
                    let questionObj={
                        question:"Which of the following group IIA elements occurs in small amounts in uranium ores",
                        choice1:"Be",
                        choice2:"Mg",
                        choice3:"Ca", 
                        choice4:"Ra"
                ...
                if (retryNumber==1) {
                    let questionObj={
                        question:"The characteristic colour obtained when Li is burnt in Bunsen flame is",
                        choice1:"Lilac",
                        choice2:"Blue",
                        choice3:"Yellow", 
                        choice4:"Crimson"
                ...
                if (retryNumber==2) {
                    let questionObj={
                        question:"Which of the elements is silvery white metallic solid at room temperature",
                        choice1:"K",
                        choice2:"Li",
                        choice3:"Cs", 
                        choice4:"Na"
